  ...
  return (
    <div className="border border-gray-200 dark:border-white/10 bg-white dark:bg-[#0a0a0a] overflow-hidden">
      ...
      <div className="p-3 lg:p-4 space-y-3">
        <div className="min-h-45 max-h-60 overflow-auto rounded border border-gray-200 dark:border-white/10 bg-black text-white dark:bg-black px-3 py-3 font-mono text-sm leading-relaxed dark-scrollbar">
