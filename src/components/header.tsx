    ...
    >
      <div className="px-8 py-4">
        <div className="flex items-center justify-between">
          ...
          <Link
            href="/"
            className="text-xl font-bold tracking-tight text-black hover:opacity-80 transition-opacity"
          >
            ENUM
          </Link>
          ...
          <div className="flex items-center space-x-4">
            <Link
              href="/login"
              className="font-mono text-xs font-medium text-gray-700 hover:text-black transition-colors tracking-wider"
            >
              LOGIN
            </Link>
            <Link
