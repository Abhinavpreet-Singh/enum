...
import { generateCWrapper } from "./cWrapper.js";

export const runCJudge = ({
  userCode,
  functionName,
  parameterTypes,
  returnType,
  ...
  return new Promise(async (resolve) => {
    ...
    const fullCode = generateCWrapper({
    ...
    fs.writeFileSync("./temp/main.c", fullCode);

    try {
      await new Promise((res, rej) => {
        exec("gcc temp/main.c -o temp/main.exe", (err, _stdout, stderr) => {
